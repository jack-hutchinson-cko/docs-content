...
*   Created by [Toby Knott](    /display/~toby.knott
    ...
    ) on [Apr 13, 2021](/pages/diffpagesbyversion.action?pageId=5931426&selectedPageVersions=5&selectedPageVersions=6 "Show changes")
...
1.  In your Apple Developer account, go to the [_Add Merchant IDs_ section](https://developer.apple.com/account/resources/identifiers/add/merchant), select **Merchant IDs** and click **Continue**.
...
1.  Log in to your [Hub account](https://hub.checkout.com/v2), go to _Settings > Apple Pay_ and click **New Certificate**.
2.  Click **Download your certificate signing request**. This will give you the `.csr` file that you'll need for your Apple Developer account.
3.  Click **Continue until step 3** and then leave this page open.
4.  Log in to your Apple Developer account, go to the [_Merchant IDs list_ section](https://developer.apple.com/account/resources/identifiers/list/merchant), and click on the merchant ID you created in step 1.
5.  In the _Apple Pay Payment Processing Certificate_ section (make sure you're not in the _Apple Pay Merchant Identity Certificate_ section), click **Create Certificate**.
...
1.  Log in to your Apple Developer account, go to the [_Merchant IDs list_ section](https://developer.apple.com/account/resources/identifiers/list/merchant) and click on the merchant ID you created in step 1.
2.  Under the _Merchant Domains_ section, click **Add Domain**.
...
3.  Log in to your Apple Developer account, go to the [_Merchant IDs list_ section](https://developer.apple.com/account/resources/identifiers/list/merchant) and click on the merchant ID you created in step 1.
4.  Under the _Apple Pay Merchant Identity Certificate_ section (make sure you're not in the _Apple Pay Payment Processing Certificate_ section), click **Create Certificate**.
...
[Add Comment](/display/DOCS/Set+up+Apple+Pay?showComments=true&showCommentArea=true#addcomment)