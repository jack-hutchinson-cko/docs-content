...
*   Created by user-faddb, last modified by [Docs shared](    /display/~docs-shared
    ) on [Apr 28, 2021](/pages/diffpagesbyversion.action?pageId=2785426&selectedPageVersions=14&selectedPageVersions=15 "Show changes")
...
You can find it in the [Hub](https://hub.checkout.com).
...
Allows you to use one of the supported languages or a custom object. Refer to the [Frames customization guide](/display/DOCS/Frames+customization+guide) for more information.

`EN-GB`

`style`

Allows you to customize the look and feel of Frames' controlled fields. Refer to the [Frames customization guide](/display/DOCS/Frames+customization+guide) for more information.
...
The `country` field only accepts two-letter ISO country codes. You can find a full list of these [here](/display/DOCS/Currency+codes).
...
*   [**Method 1: Standard approach**](#tabs-8ab2cae0-28bc-4b3f-be34-3a135a32272b-1)
*   [**Method 2: Configuration options**](#tabs-8ab2cae0-28bc-4b3f-be34-3a135a32272b-2)
...
[Add Comment](/display/DOCS/Frames+reference?showComments=true&showCommentArea=true#addcomment)