...
*   Created by user-faddb, last modified by [Docs shared](    /display/~docs-shared
    ) on [May 11, 2021](/pages/diffpagesbyversion.action?pageId=2785311&selectedPageVersions=26&selectedPageVersions=27 "Show changes")
...
The new version of Frames was released on July 12, 2019. If you'd like to upgrade from the old version, simply follow our [migration guide](/display/DOCS/Frames+migration+guide). If you need access to the legacy documentation, please contact our Support team at [support@checkout.com](mailto:support@checkout.com).
...
![](/download/attachments/2785311/Frames.png?version=5&modificationDate=1620730510276&api=v2)

Try it out
----------

Use one of our [test cards](/display/DOCS/Test+card+numbers) and corresponding CVV to try Frames out for yourself. For example `4242 4242 4242 4242` with CVV `100`.
...
Make sure you have your `public_key`. You can find it in the [Hub](https://hub.checkout.com), under _Settings > Channels_. If you don't have an account with us yet, you can [create a free test account now](https://checkout.com/get-test-account).
...
Although we kept our demo simple, you have a lot of control over the appearance of your form—from the colors and styling, to whether you want to display one input field or several. Check out our [Frames customization guide](/display/DOCS/Frames+customization+guide) for more details and examples.

### Configuration options

You'll find a list of all the possible configuration options in our [Frames reference guide](/display/DOCS/Frames+reference).

Next step
---------

Now that you've got your card token, you're ready to [request your first card payment](/display/DOCS/Request+a+card+payment).
...
[Add Comment](/display/DOCS/Frames?showComments=true&showCommentArea=true#addcomment)