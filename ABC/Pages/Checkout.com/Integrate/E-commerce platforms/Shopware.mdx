...
. Log in to your test account on the [Hub sandbox](https://sandbox.checkout.com/). 2. In the left menu, go to *Settings > Channels*, and make a note of your secret and public API keys.![](/download/attachments/23003631/channel_settings.png?version=1&modificationDate=1618242727818&api=v2) 3. Scroll down to the *Webhooks* section of the page and click **New webhook**. 4. Enter the following URL, replacing `example.com` with the URL of your shop: `example.com/CkoCheckoutWebhook`.
...
. Select **API - v2.0**. 6. Tick **Select all**, then click **Create webhook**.  
 ![](/download/attachments/23003631/Screenshot%202021-04-27%20at%2016.24.29.png?version=1&modificationDate=1619537147043&api=v2) 7. Click on the webhook you just created, and make a note of the private shared API key.  
