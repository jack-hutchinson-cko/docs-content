...
. Log in to your [Shopify admin](https://www.shopify.com/login?redirect=authorize_gateway%2F1031113). 2. After logging in, you should see an `Add payment gateway` message. Click **Add payment gateway**. 3. Enter your public and secret API keys – you'll find these in the [Hub](https://hub.checkout.com/) – and select the payment methods permitted for your account (Visa, MasterCard, Amex, etc.). 4. After completing the form, click **Activate**.  
 ![](/download/attachments/5931126/shopify_offsite.png?version=1&modificationDate=1587549197562&api=v2)

### The Hub

. Log in to your [Hub](https://hub.checkout.com/) account. 2. Go to _Settings_ > *Channels*. 3. Enter the relevant redirection URLs for your environment:
...
. Scroll down to *Webhooks* and click **New webhook**. 5. Enter the relevant URL for your environment:
...
. Select **API - v1.0**. 7. Tick **Select all**, then click **Create webhook**.
