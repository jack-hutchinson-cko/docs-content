...
*   Created by [Toby Knott](    /display/~toby.knott
    ...
    ) on [Apr 30, 2021](/pages/diffpagesbyversion.action?pageId=5931114&selectedPageVersions=13&selectedPageVersions=14 "Show changes")
...
1.  While in the _Settings > Channels_ section of your Hub account, scroll down to the _Webhooks_ section and click **New webhook**.
...
[Add Comment](/display/DOCS/PrestaShop?showComments=true&showCommentArea=true#addcomment)