...
*   Created by user-faddb, last modified by [Jack Hutchinson](    /display/~jack.hutchinson
    ) on [Mar 19, 2021](/pages/diffpagesbyversion.action?pageId=2785490&selectedPageVersions=3&selectedPageVersions=4 "Show changes")
...
*   **VAT:** only applicable to merchants in the UAE (ISO-code _ARE_), it shows the amount of value-added tax charged. Learn more below.
...
[Add Comment](/display/DOCS/Statements+explained?showComments=true&showCommentArea=true#addcomment)