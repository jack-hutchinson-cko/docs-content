...
*   Created by user-faddb, last modified by [Jack Hutchinson](    /display/~jack.hutchinson
    ) on [Mar 19, 2021](/pages/diffpagesbyversion.action?pageId=2785633&selectedPageVersions=4&selectedPageVersions=5 "Show changes")
...
This action is applicable when performing a [card verification](/display/DOCS/Card+verification).
...
The payout was declined. Refer to the [response code](/display/DOCS/Response+codes) for more information.
...
[Add Comment](/display/DOCS/About+payment+actions?showComments=true&showCommentArea=true#addcomment)