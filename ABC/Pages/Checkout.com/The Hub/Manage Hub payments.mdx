...
*   Created by user-faddb, last modified by [Jack Hutchinson](    /display/~jack.hutchinson
    ) on [Apr 27, 2021](/pages/diffpagesbyversion.action?pageId=2785624&selectedPageVersions=9&selectedPageVersions=10 "Show changes")
...
1.  In the _Payments_ screen, click **Create payment** in the top right.
...
6.  Optionally, delay the capture or add extra information about the payment by clicking **More options** and filling in the desired fields.
7.  Click **Create payment** to confirm. The new payment is added to the _Payments_ screen.
...
1.  In the _Payments_ screen, click on a payment. The payment details pane opens on the right.
...
[Add Comment](/display/DOCS/Manage+Hub+payments?showComments=true&showCommentArea=true#addcomment)