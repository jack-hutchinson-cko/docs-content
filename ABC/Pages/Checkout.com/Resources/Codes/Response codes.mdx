...
| 30017 | Issuer does not allow original credit transaction |  Issuer does not allow original credit transactions (OCTs) over Visa SMS. Only applies to OCTs. |
| 30018 | Issuer does not allow money transfer payout | Issuer does not allow money transfer original credit transactions (OCTs). Only applies to OCTs. |
| 30019 | Issuer does not allow non-money transfer payout | Issuer does not allow non-money transfer original credit transactions (OCTs). Only applies to OCTs. |
