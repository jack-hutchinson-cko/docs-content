...
*   Created by user-faddb, last modified by [Cristina Szilagyi](    /display/~cristina.szilagyi
    ) on [Apr 21, 2021](/pages/diffpagesbyversion.action?pageId=2785399&selectedPageVersions=5&selectedPageVersions=6 "Show changes")
...
[Add Comment](/display/DOCS/Currency+codes?showComments=true&showCommentArea=true#addcomment)