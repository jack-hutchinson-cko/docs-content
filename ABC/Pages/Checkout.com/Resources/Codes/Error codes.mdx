...
| `currency_invalid` |  The three-letter ISO currency code is invalid. <br> See [currency codes](/display/DOCS/Currency+codes) for a full list of valid currency codes. |
