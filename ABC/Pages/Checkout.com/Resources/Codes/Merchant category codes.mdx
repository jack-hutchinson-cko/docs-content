...
*   Created by user-faddb, last modified by [Toby Knott](    /display/~toby.knott
    ) on [Jun 03, 2021](/pages/diffpagesbyversion.action?pageId=2785406&selectedPageVersions=3&selectedPageVersions=4 "Show changes")
...
[Add Comment](/display/DOCS/Merchant+category+codes?showComments=true&showCommentArea=true#addcomment)