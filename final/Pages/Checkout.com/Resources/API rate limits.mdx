...
| ---- | ---- | ---- | ---- | --- |
| Read | HTTP GET operations used to retrieve data/resources | 100| *   Get payment details
*   Get disputes

 |
| Write | HTTP POST/PUT/DELETE operations used to create or update data/resources | 100| *   Authorize payment
*   Refund payment
