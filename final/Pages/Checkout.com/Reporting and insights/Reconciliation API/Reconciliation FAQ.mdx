...
| Action type | Amount and fees |
| ---- | ---- |
| Authorization| *   Gateway Fee
*   Authorization Fee
*   Scheme Fixed Fee
*   Scheme Variable Fee
*   Reconciliation Fee
...
*   Reconciliation Fee
 ...
 |
| Retrieval| *   Retrieval fee

 |
| Chargeback| *   Chargeback (ADJM)
*   Chargeback Fee
...
*   Chargeback (RPDW)
 ...
 |
| Payout to Card| *   PayoutsToCard Fee
