...
*   [**Live**](#tabs-c3716356-3f8d-41d4-bef6-e92e97c2ac6e-1)
*   [**Sandbox**](#tabs-c3716356-3f8d-41d4-bef6-e92e97c2ac6e-2)
...
STRING | The currency in which the payment is being made (three-letter ISO 4217 code). Set this to `EGP`. |
| 
...
STRING | The type of payment source. Set this to `fawry`. |
| 
...
STRING| The customer's mobile number. The number must:
...
STRING| The profile ID that the merchant has assigned to the customer.
...
STRING| Use to set a date and time (UTC, in ISO 8601 format) on which the payment will expire.
...
ARRAY | An array of Fawry product objects. |
| 
...
INTEGER| The quantity of product being purchased.
...
INTEGER| The unit price of the product.
...
*   [**Live**](#tabs-c9be6567-b273-468c-8866-185028c5d9aa-1)
*   [**Sandbox**](#tabs-c9be6567-b273-468c-8866-185028c5d9aa-2)
...
*   [**Sandbox**](#tabs-e84d2636-c59c-44a4-82d5-012ae7a3b784-1)
...
*   [**Sandbox**](#tabs-7e0f47ed-bde9-463d-b74d-7e84f50f2eef-1)
