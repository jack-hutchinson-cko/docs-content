...
*   [**Live**](#tabs-8da4d7ca-ca15-443e-9eea-db6f49a974a4-1)
*   [**Sandbox**](#tabs-8da4d7ca-ca15-443e-9eea-db6f49a974a4-2)
...
STRING| The type of payment. Set this to `sepa`.
...
STRING| A reference that you can later use to identify the source.
...
OBJECT| Additional data required to create SEPA payment sources.
...
STRING| The type of mandate. Set to `single` for one-off payments or `recurring` for recurring payments.
...
OBJECT| The account owner's billing address.
...
STRING| Line 1 of the billing address.
...
STRING| Line 2 of the billing address.
...
STRING | The country of the billing address, using the two-letter ISO code (e.g., `GB` for the United Kingdom). |
| 
...
STRING | The valid country code for the phone number (e.g., `+44` for the United Kingdom). |
| 
...
STRING | Details about the customer associated with the source. |
| 
...
*   [**Recurring mandate request**](#tabs-c3dc85b4-0fee-4a46-883d-40c9aea228b1-1)
*   [**One-off mandate request**](#tabs-c3dc85b4-0fee-4a46-883d-40c9aea228b1-2)
...
*   [**Live**](#tabs-891ec36f-138e-4c14-b2f4-559ddcbea716-1)
*   [**Sandbox**](#tabs-891ec36f-138e-4c14-b2f4-559ddcbea716-2)
...
STRING | The type of payment source. Set this to `id`. |
| 
...
STRING | The source ID (received in the response above). |
| 
...
STRING | The payment currency (three-letter ISO 4217 code). |
| 
...
STRING | A reference with which you can later identify the payment. |
...
*   [**Live**](#tabs-74345b2f-b90a-4e90-969f-7ce7daa1d3d3-1)
*   [**Sandbox**](#tabs-74345b2f-b90a-4e90-969f-7ce7daa1d3d3-2)
...
REQUIRED| The source ID (you'll find this in the response of the source creation).
...
*   [**Live**](#tabs-70072cb0-8a3a-4455-8700-697a28b56a02-1)
*   [**Sandbox**](#tabs-70072cb0-8a3a-4455-8700-697a28b56a02-2)
...
*   [**Live**](#tabs-2c447485-e4a4-4f7f-bdda-42a04f57b9bb-1)
*   [**Sandbox**](#tabs-2c447485-e4a4-4f7f-bdda-42a04f57b9bb-2)
