...
*   [**Live**](#tabs-b5389ab9-3e72-48cc-8db4-9ed0149bf448-1)
*   [**Sandbox**](#tabs-b5389ab9-3e72-48cc-8db4-9ed0149bf448-2)
...
STRING| The type of token. Set this to `vts` for Visa or `mdes` for Mastercard.
...
STRING| The Electronic Commerce Indicator security level associated with the token. Optional if `previous_payment_id` is specified and `3ds.enabled` is `false`.
