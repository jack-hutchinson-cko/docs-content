...
*   [**Google Pay API request (web)**](#tabs-8f9aa8d9-9955-4d2e-9c26-d8f2906c43b1-1)
*   [**Google Pay API request (Android)**](#tabs-8f9aa8d9-9955-4d2e-9c26-d8f2906c43b1-2)
...
*   [**Live**](#tabs-b7cdd6f3-6cc1-447a-ab10-3d67f9212a50-1)
*   [**Sandbox**](#tabs-b7cdd6f3-6cc1-447a-ab10-3d67f9212a50-2)
...
STRING | The type of card details to be tokenized. Set this to `googlepay`. |
| 
...
STRING | The Google Pay payment token. |
| 
...
STRING | Verifies the message came from Google. The signature is created using ECDSA. |
| 
...
STRING | Identifies which encryption/signing scheme this message has been created. In this way, the protocol can evolve over time if needed. If it is not set, assume ECv0. |
| 
...
STRING | A serialized JSON string containing the `encryptedMessage`, `ephemeralPublicKey` and `tag`. To simplify the signature verification process, this value is serialized. |
