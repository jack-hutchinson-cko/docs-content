...
*   [**Live**](#tabs-15732d9c-e48e-4a7a-afae-be69dfd570e4-1)
*   [**Sandbox**](#tabs-15732d9c-e48e-4a7a-afae-be69dfd570e4-2)
...
STRING | The currency in which the payment is being made (three-letter ISO 4217 code). Set this to `PLN`. |
| 
...
STRING | The type of payment source. Set this to `p24`. |
| 
...
STRING | The country in which the payment instrument is issued/operated (two-letter ISO 3166 code). Set this to `PL`. |
| 
...
*   [**Live**](#tabs-f6427a82-20a6-49c9-82de-d035d4bf04f0-1)
*   [**Sandbox**](#tabs-f6427a82-20a6-49c9-82de-d035d4bf04f0-2)
