...
1.  [Request a payment](#EPS-requestapayment)
2.  [Redirect the customer](#EPS-redirectthecustomer)
...
*   [**Live**](#tabs-320f16c3-9d94-4a45-afd7-9c26d3b4fb45-1)
*   [**Sandbox**](#tabs-320f16c3-9d94-4a45-afd7-9c26d3b4fb45-2)
...
STRING| The type of payment source. Set this to `eps`.
...
STRING | The three-letter ISO 4217 currency code. Set this to `EUR`. |
| 
...
*   [**Live**](#tabs-99c8a20e-9f4d-4281-b5dc-555cfcdf3389-1)
*   [**Sandbox**](#tabs-99c8a20e-9f4d-4281-b5dc-555cfcdf3389-2)
...
7.  In the _mobileTAN-Eingabe_ field, enter `123456` and confirm by clicking **OK**.
8.  Click **zurück**. You should then be redirected to your predefined success URL.
