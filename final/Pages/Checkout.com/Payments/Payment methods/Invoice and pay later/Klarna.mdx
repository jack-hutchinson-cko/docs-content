...
*   [**Live**](#tabs-8c5336b2-9fc9-467e-ad7e-3625a17f040a-1)
*   [**Sandbox**](#tabs-8c5336b2-9fc9-467e-ad7e-3625a17f040a-2)
...
STRING| The country in which the purchase is being made (two-letter ISO 3166 code).
...
INTEGER| The total amount of the order, including tax and any discounts.
...
INTEGER| The total tax amount of the order.
...
*   [**201 Successfully created Klarna session**](#tabs-54864699-7442-4034-8adb-f54613e4f34d-1)
*   [**422 Request could not be accepted**](#tabs-54864699-7442-4034-8adb-f54613e4f34d-2)
...
OBJECT| Use this to contain the container ID, `payment_method_categories`, and `instance_id`.
...
STRING| The ID you specified for the Klarna container above.
...
ARRAY| The `identifier`s of the `payment_method_categories` you want to present to the customer. (i.e. `pay_later` and/or `slice_it`)
...
STRING| The ID you'll use to identify this instance of the Klarna Payments client.
...
OBJECT| If the customer has changed any of their order or billing information, this can be used to update the session.
...
STRING| The customer's locale (RFC 1766 code).
...
OBJECT| Details about the customer's billing address.
...
OPTIONAL| Details about the customer's shipping address.
...
INTEGER| Total tax amount of the order.
...
FUNCTION| Catches the response from `Klarna.Payments.load()` for further processing.
...
*   [**Positive response: Klarna offered**](#tabs-de8d8049-cc65-4d04-9492-49e12da9d901-1)
*   [**Adjust and try again**](#tabs-de8d8049-cc65-4d04-9492-49e12da9d901-2)
*   [**Klarna not offered**](#tabs-de8d8049-cc65-4d04-9492-49e12da9d901-3)
...
OBJECT| Use this to pass the `instance_id`.
...
STRING| The ID of the Klarna Payments instance you want to authorize.
...
OBJECT| Use this to provide any order or billing details that the customer has changed.
...
FUNCTION| Catches the response from `Klarna.Payments.authorize()` for further processing.
...
*   [**Successful**](#tabs-e78dd5a1-059d-4145-ae04-3bbf13c22ff9-1)
*   [**Rejected with solvable errors**](#tabs-e78dd5a1-059d-4145-ae04-3bbf13c22ff9-2)
*   [**Rejected**](#tabs-e78dd5a1-059d-4145-ae04-3bbf13c22ff9-3)
...
*   [**Live**](#tabs-9792084a-0b14-420f-b10b-7c757e52ab4c-1)
*   [**Sandbox**](#tabs-9792084a-0b14-420f-b10b-7c757e52ab4c-2)
...
BOOLEAN| Choose whether or not to capture the payment.
...
STRING| The type of payment source. Set this to `klarna`.
...
STRING| The Klarna authorization token, which you received when you authorized the order.
...
BOOLEAN| Allows you to trigger auto-capture of the payment.
...
INTEGER| The total tax amount for the order.
...
OBJECT| Details about the customer's shipping address.
...
STRING| Use this to store an internal order number or other reference. If set, this will be shown on the confirmation page as `order number`.
...
STRING| Use this to store an internal order number or other reference.
...
OBJECT| Additional purchase information required for some industries.
...
*   [**Live**](#tabs-1becd3ab-1bd4-445c-a734-2cdcc2c3586b-1)
*   [**Sandbox**](#tabs-1becd3ab-1bd4-445c-a734-2cdcc2c3586b-2)
...
REQUIRED | The payment ID you received in the response when you placed the order. |
...
INTEGER| The amount you wish to capture. If you don't specify, you will capture the full payment amount.
...
STRING| A reference, such as an order number, you can later use to identify this payment.
...
OBJECT| A set of key-value pairs that you can attach to a payment. You can use this to store additional information in a structured format.
...
STRING| Type which can be used as a discriminator for a more generic capture endpoint with property bags.
...
OBJECT| Contains the order and shipping information.
...
ARRAY| The shipping information for the order.
...
*   [**202 Capture accepted**](#tabs-dcff5c76-5422-4446-93d7-7c8244a13ad2-1)
*   [**422 Invalid data was sent**](#tabs-dcff5c76-5422-4446-93d7-7c8244a13ad2-2)
...
*   [**Live**](#tabs-ea97c19c-7b17-4d3f-8542-6b97d0c534b8-1)
*   [**Sandbox**](#tabs-ea97c19c-7b17-4d3f-8542-6b97d0c534b8-2)
...
REQUIRED | The payment ID (prefixed with `pay_`) you received in the response when you placed the order. |
...
*   [**202 Void accepted**](#tabs-0e8f04d9-84fe-4963-af65-cc091c35c998-1)
*   [**422 Invalid data was sent**](#tabs-0e8f04d9-84fe-4963-af65-cc091c35c998-2)
