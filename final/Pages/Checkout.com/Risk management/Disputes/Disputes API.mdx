...
| Webhook event type
 ...
 |
| --- | --- | --- |
| `evidence_required`| An action on your side is required (you need to respond to the dispute). At this stage, your account gets debited the disputed amount.
...
View a [dispute resolved webhook example](/display/DOCS/dispute_resolved).  
 ...
 |
| `canceled`| The dispute is canceled by the issuing bank and your account is credited back of the amount of the dispute. You don’t need to take any further action.
...
View a [dispute canceled webhook example](/display/DOCS/dispute_canceled).
 ...
 |
| `evidence_under_review`| You have submitted evidence to defend against the dispute. Your evidence is now under review by our Disputes team. Once reviewed, the team will send it to the card scheme for review. No further action is required on your side.

| There is no equivalent webhook because your action triggered the status change.

 |
| `lost`| The issuing bank has rejected your evidence and you have lost the dispute. There are no further financial implications.
...
View a [dispute lost webhook example](/display/DOCS/dispute_lost).
 ...
 |
| `won`| The issuing bank has accepted your evidence and you have won the dispute. Your account has been credited back of the amount of the dispute.
...
View a [dispute expired webhook example](/display/DOCS/dispute_expired).
 ...
 |
| `accepted`| You have accepted the dispute. There is no further implication or action required.
...
REQUIRED| The dispute identifier. It is prefixed by `dsp_`.
...
*   [**Live**](#tabs-90eceb21-39a8-47ef-a1a6-9fafa7b47569-1)
*   [**Sandbox**](#tabs-90eceb21-39a8-47ef-a1a6-9fafa7b47569-2)
...
STRING| The number of items to return.
...
INTEGER| The number of items to skip before starting to collect the result set.
...
STRING| Filter by 'last update' after the provided value (formatted in ISO 8601).
...
STRING| Filter by 'last update' before the provided value (formatted in ISO 8601).
...
STRING| One or more statuses, separated by commas, e.g. `evidence_required` and `evidence_under_review`.
...
*   [**Live**](#tabs-2643386d-f528-45ac-b226-1139967e35f3-1)
*   [**Sandbox**](#tabs-2643386d-f528-45ac-b226-1139967e35f3-2)
...
*   [**Live**](#tabs-f6750ec5-e21f-4bd8-a80b-3fe09705a1c0-1)
*   [**Sandbox**](#tabs-f6750ec5-e21f-4bd8-a80b-3fe09705a1c0-2)
...
STRING| Your proof of delivery or service. Please make sure to add the date of delivery here too.
...
STRING| The invoice or receipt of the payment.
...
STRING| Your invoice showing two distinct transactions. This is relevant in case the cardholder claims a payment was charged twice (duplicate).
...
STRING| Customer communication relevant to the case which proves that the payment was valid.
...
STRING| Your refund or cancellation policy. Please always just upload the part of the document that is relevant to this case.
...
STRING| Your recurring transaction agreement. Please always just upload the part of the document that is relevant to this case.
...
STRING| Additional evidence supporting your case that does not fall under the above categories.
...
*   [**Live**](#tabs-d8349537-623a-4300-9f77-9eee0a5cb0f9-1)
*   [**Sandbox**](#tabs-d8349537-623a-4300-9f77-9eee0a5cb0f9-2)
...
*   [**Live**](#tabs-0fecaae1-850f-4813-9c7b-4225877cc95a-1)
*   [**Sandbox**](#tabs-0fecaae1-850f-4813-9c7b-4225877cc95a-2)
...
*   [**Live**](#tabs-409f5708-1988-4e0f-bed5-cead21fd98b6-1)
*   [**Sandbox**](#tabs-409f5708-1988-4e0f-bed5-cead21fd98b6-2)
