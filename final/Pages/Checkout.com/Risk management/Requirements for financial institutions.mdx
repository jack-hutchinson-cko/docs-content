...
REQUIRED| *   **Visa**: If the payment is being made with a VISA card, then provide the first six digits and the last four digits of the primary recipient’s card, without any spaces. Or, the first 10 digits of the primary recipient’s account number.
...
REQUIRED | The date of birth of the primary recipient in the following format: `yyyy-mm-dd`| `1991-12-30`
...
REQUIRED | The first part of the UK postcode. For example, W1T 4TJ would be `W1T`. | `W1T` | 6 |
| 
...
REQUIRED | The first six characters of the primary recipient’s surname. Only alphabetic characters are allowed. | `Smith` | 6 |
