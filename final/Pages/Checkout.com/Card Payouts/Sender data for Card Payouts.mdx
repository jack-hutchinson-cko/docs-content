...
STRING| REQUIRED (if `accountNumber` not available) | 

REQUIRED (if `accountNumber` not available)| The merchant's unique customer ID.
...
STRING| REQUIRED (if available) | 

REQUIRED (if available)| Up to 19 characters.
...
REQUIRED| The full name must be provided. This information will show on the cardholder's statement.
...
REQUIRED| Required under UK law.
...
REQUIRED (if applicable) | Up to 2 characters. |
| 
...
REQUIRED| The merchant's unique customer ID.
...
REQUIRED| Merchant or government entity name. This information will show on the cardholder's statement.
...
REQUIRED| Legal first name of sender. Do not use processor or intermediary name. This information will show on the cardholder's statement.
...
REQUIRED| Legal last name of sender. Do not use processor or intermediary name. This information will show on the cardholder's statement.
...
STRING| REQUIRED (if `reference` not available) | 

REQUIRED (if `reference` not available) | Up to 19 characters. |
| 
...
REQUIRED (if `accountNumber` not available) | Up to 16 alphanumeric characters. |
| 
