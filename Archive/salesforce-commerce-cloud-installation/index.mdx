...
1\. In the \*Business Manager\*, go to \*\*Administration > Sites > Manage Sites\*\*. 2. In your target site’s settings, add \`int_checkoutcom\` to the cartridge path like in the following example:
