...
2
 ...
 "id": "pay\_tok\_45ce4182-4934-40bd-be5f-761ed81ebf9b",
...
<span class="step\_hl">Step 4:</span> \*\*Verify the payment token\*\* After successfully verifying the customer's security details, the issuing bank processes the payment. The customer is then redirected to the merchant's Payment Confirmation page. On your server, grab and verify the \[payment token\](doc:verify-a-3-d-secure-payment) in the redirect URL. 
