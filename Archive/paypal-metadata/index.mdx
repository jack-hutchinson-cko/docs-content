...
The following metadata can be used exclusively with PayPal payments. _ [Standard metadata](/docs/paypal-metadata#section-standard-metadata) _ [Metadata for Airlines](/docs/paypal-metadata#section-metadata-for-airlines) — for merchants processing airline tickets.
