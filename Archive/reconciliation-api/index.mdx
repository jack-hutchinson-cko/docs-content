...
<span class="number\_hl">2.</span> \*\*Payouts\*\* Grouped by payout currency, this
section details all payouts to your bank account within the chosen date range. The
table below describes this data and its purpose.{" "}
...
"requested_on": "2018-03-20T20:30:00.000",
...
<span class="number\_hl">2:</span> \*\*Actions\*\* This section outlines all the
actions—authorization, void, capture, refund, retrieval, and chargeback—which have
been administered to a transaction. The table below outlines and explains the parameters
of the report.{" "}
...
<span class="number\_hl">3:</span> \*\*Breakdown\*\* The amounts summary shows the
amounts correlated with a particular action. The table below shows the full list
of these parameters and their explanations.{" "}
