...
You are required to include the CVV. _If you don't include these, you will receive an 'invalid CVV' response._
...
You are not required to include the CVV. _If you **do** include it, it will be subject to verification checks._
