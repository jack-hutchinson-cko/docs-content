...
_Try it out!_ _ use one of our [test cards](doc:testing#section-test-card-numbers), for example, :fa-cc-visa: <span class="card-number">4242 4242 4242 4242</span> _ use any future expiry date (mm/yy) \* and the CVV is :fa-lock: **100**
