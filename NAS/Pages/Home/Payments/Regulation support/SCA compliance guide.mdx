...
*   Created by [Toby Knott](    /display/~toby.knott
    ), last modified on [May 26, 2021](/pages/diffpagesbyversion.action?pageId=8490095&selectedPageVersions=5&selectedPageVersions=6 "Show changes")
...
In addition, you must include additional parameters in your payment request to clearly identify such transactions as merchant-initiated. Learn more in our [stored card details guide](/display/x/About+stored+card+details).
...
The first transaction that starts the subscription. This could be a [zero-dollar authorization/card verification](/display/x/Card+verification).
...
For more details about the additional parameters required for payments using saved cards, see our [stored card details guide](/display/x/About+stored+card+details).
...
*   [**3DS challenge request**](#tabs-0e6138ad-2551-4c12-8cc1-34cbc587270c-1)
*   [**Exemption request**](#tabs-0e6138ad-2551-4c12-8cc1-34cbc587270c-2)
...
[Add Comment](/display/x/SCA+compliance+guide?showComments=true&showCommentArea=true#addcomment)