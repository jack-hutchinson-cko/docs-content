...
*   Created by [Toby Knott](    /display/~toby.knott
    ) on [Jun 08, 2021](/pages/viewpreviousversions.action?pageId=25526750 "Show changes")
...
Each dispute has a [reason code](/display/x/Chargeback+codes) associated with it, which tells you the specific grounds for the dispute. For example, your customer claims the transaction was fraudulent, or that they did not receive the product they paid for, or that you’ve continued charging them for a subscription they think they canceled.
...
You can manage and respond to disputes in two ways: through the [Dashboard](/display/x/Manage+disputes), or our [API](/display/x/Disputes+API).
...
If you choose to challenge a dispute, make sure you know the specific [reason code](/display/x/Chargeback+codes) for it and then start preparing the evidence you want to submit to the card issuer to make your case.
...
Learn more about the [dispute categories and the best evidence to submit](https://docs.checkout.com/four/risk-management/disputes#Disputes-Disputereasonsandrecommendedevidence).

You can upload and submit evidence through the [Dashboard](/display/x/Manage+disputes) or with our [API](/display/x/Disputes+API).
...
Learn why disputes are raised and the best evidence to defend against them.](https://docs.checkout.com/four/risk-management/disputes#Disputes-Disputereasonsandrecommendedevidence)[

### Manage disputes from the Dashboard

Learn how to handle disputes from your Dashboard.](https://docs.checkout.com/four/dashboard/manage-disputes)
