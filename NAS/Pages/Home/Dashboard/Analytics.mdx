...
You can create a new board by selecting *\+ New board* on the boards page.
...
. After creating a chart in *Data explorer* and selecting *Save chart*. 2. Directly from the board by selecting *\+ New widget / + New chart*.
