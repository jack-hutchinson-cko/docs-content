...
*   Created by user-faddb, last modified by [Jack Hutchinson](    /display/~jack.hutchinson
    ) on [Mar 22, 2021](/pages/diffpagesbyversion.action?pageId=8488064&selectedPageVersions=4&selectedPageVersions=5 "Show changes")
...
1.  Click the search bar to get started.  
...
4.  Press Enter or click **See all results** to apply your filter. The _Payments_ screen will be updated to show your results.
5.  If you want to undo your search, click the cross in the search bar.
...
[Add Comment](/display/x/Filter+payments?showComments=true&showCommentArea=true#addcomment)
