...
*   Created by user-faddb, last modified on [Aug 26, 2020](/pages/diffpagesbyversion.action?pageId=8488188&selectedPageVersions=1&selectedPageVersions=2 "Show changes")
...
[Add Comment](/display/x/Currency+codes?showComments=true&showCommentArea=true#addcomment)